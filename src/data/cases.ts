...
export const DOSSIERS: DossierData[] = [
  {
    ...
    summary:
      'Fromville sería un espacio artificial y limitado contenido dentro de nuestra realidad, creado o deformado por el sacrificio original.',
    thesis:
    ...
    evidence: [
      {
        ...
        text: 'Todas las llegadas se producen después del encuentro con el árbol de la carretera, que actuaría como paso entre realidades.',
      },
      {
        title: 'ESPACIO CERRADO',
        text: 'La carretera devuelve siempre al mismo punto, como si el territorio disponible fuera limitado y estuviera plegado sobre sí mismo.',
      },
      {
        title: 'LEYES ANÓMALAS',
        text: 'La electricidad sin fuente, la curación acelerada y ciertos viajes temporales sugieren reglas físicas distintas.',
      },
      {
        title: 'ORIGEN CÓSMICO',
        text: 'Las rocas rojas, el aura de la entidad y el sacrificio se conectan en una posible creación artificial de Fromville.',
      },
    ],
    doubts: [
  ...
  },
  {
    ...
    summary:
      'El Niño de Blanco podría ser la manifestación consciente del Faraway Tree, nacida de la esperanza depositada por los niños en sus raíces.',
    thesis:
      'Sus primeras apariciones están ligadas a árboles de lejanía y su función de guía reproduce el poder de transporte del árbol. Su apariencia infantil sería una forma idealizada de la esperanza de los niños sacrificados. Incluso sus actos más crueles se reinterpretan como ayudas difíciles de comprender desde fuera.',
    evidence: [
      {
        title: 'APARICIONES CONECTADAS',
        text: 'Varias de sus primeras intervenciones conducen directamente a Víctor, Julie, Boyd o Sara hacia un árbol de lejanía.',
      },
      {
        title: 'MISMA FUNCIÓN',
        text: 'El niño aparece, desaparece y guía; el árbol desplaza a las personas y decide dónde terminan.',
      },
      {
        title: 'ESPERANZA EN LAS RAÍCES',
        text: 'La esperanza de los niños habría alimentado el árbol, explicando por qué una entidad vinculada a él intenta ayudarlos.',
      },
      {
        title: 'PATRÓN DE ELEGIDOS',
        text: 'Desaparece cuando no hay personas capaces de continuar la misión y vuelve con la llegada de Tabitha, Jade y la familia Matthews.',
      },
    ],
    doubts: [
  ...
  },
  {
    ...
    summary:
      'Las cuevas y el Lago de las Lágrimas serían la verdadera zona de resolución, aunque la visión que impulsa el plan podría ser una trampa.',
    thesis:
      'El árbol podría servir para recordar, no para escapar. La solución real estaría bajo tierra: liberar los restos de los niños, descubrir el lago subterráneo o alcanzar una capa más profunda de Fromville. La presencia de arañas durante la visión de Jade abre una lectura opuesta: el Hombre de Amarillo podría estar guiando el plan para que fracase de una forma concreta.',
    evidence: [
      {
        title: 'PISTAS HACIA ABAJO',
        text: 'El libro sobre cómo entra la luz, el anillo que cae por las escaleras y la mano que surge de la tierra repiten una dirección descendente.',
      },
      {
        title: 'AGUA SUBTERRÁNEA',
        text: 'La lluvia se filtra en las cuevas y el goteo en zonas profundas permite imaginar un acuífero o Lago de las Lágrimas bajo Fromville.',
      },
      {
        title: 'RESTOS DE LOS NIÑOS',
        text: 'El plan de Jade convierte los huesos y la sala del sacrificio en objetivos físicos que podrían liberar o fijar a los niños.',
      },
      {
        title: 'ARAÑAS Y MANIPULACIÓN',
        text: 'Las arañas de la visión pueden señalar que la entidad intervino en la experiencia para conducir al grupo hasta una trampa.',
      },
    ],
    doubts: [
  ...
  },
  {
    ...
    summary:
      'La esperanza de los niños escapó hacia el árbol y dejó el ritual abierto, obligando a Fromville a repetir ciclos para intentar completarlo.',
    thesis:
    ...
    evidence: [
      {
        title: 'ESPERANZA DESVIADA',
        text: 'La esperanza de los niños se habría depositado en las raíces del árbol en vez de alimentar por completo a la entidad.',
      },
      {
        title: 'CICLOS REPETIDOS',
        text: 'El reinicio constante del pueblo sería el intento de corregir un sacrificio que quedó incompleto.',
      },
      {
        title: 'ROMPER ANTES QUE MATAR',
        text: 'La entidad dedica tiempo a destruir psicológicamente a ciertos personajes, como si necesitara agotar su esperanza.',
      },
      {
        title: 'ROLES SIN RESOLVER',
        text: 'Boyd, Abby, Elgin o Sara podrían ocupar lugares de la historia original todavía no identificados.',
      },
    ],
    doubts: [
  ...
  },
  {
    ...
    summary:
      'Su poder podría proceder de materiales que absorbieron la esperanza o la energía del sacrificio original.',
    thesis:
      'Los tótems podrían estar tallados con madera del árbol de lejanía, mientras los talismanes podrían proceder de las piedras utilizadas en el sacrificio. En ambos casos, su capacidad para proteger o dañar dependería de contener la misma energía que la entidad intenta consumir.',
    evidence: [
      {
        title: 'MADERA DEL ÁRBOL',
        text: 'Las ramas aparentemente arrancadas del Faraway Tree permiten imaginar que parte de su madera se usó para fabricar tótems o armas.',
      },
      {
        title: 'PIEDRAS AUSENTES',
        text: 'Las siete piedras del ritual no aparecen en la sala actual y podrían haber sido transformadas en talismanes.',
      },
      {
        title: 'ENERGÍA COMPARTIDA',
        text: 'Árbol, niños y objetos quedarían conectados por la esperanza liberada durante el sacrificio.',
      },
      {
        title: 'PRUEBAS EN T4',
        text: 'Los personajes convierten los tótems en lanzas y los prueban contra los monstruos, aunque el resultado obliga a revisar la hipótesis.',
      },
    ],
    doubts: [
  ...
  },
  {
    ...
    summary:
      'Una lectura deliberadamente extrema reinterpreta a Jade y Christopher como manipuladores vinculados al sacrificio.',
    thesis:
      'La teoría reúne el miedo de Miranda a Christopher, la ausencia de peticiones de "recuerda" dirigidas a Jade, la marioneta Jasper, el doble sentido de "play", la llegada con Toby y varias conexiones francesas. El propio autor termina aclarando que no la considera una predicción probable, sino un ejercicio para revisar escenas desde otro punto de vista.',
    evidence: [
      {
        title: 'CHRISTOPHER GENERABA MIEDO',
        text: 'Miranda ocultó a sus hijos en un lugar que Christopher no conocía y Víctor lo recuerda como una amenaza.',
      },
      {
        title: 'JASPER Y LOS HILOS',
        text: 'La marioneta se convierte en metáfora de un personaje que podría manipular a otros desde la sombra.',
      },
      {
        title: 'TOBY COMO TESTIGO',
        text: 'La llegada de Jade se reinterpreta a partir de que Toby apenas lo menciona y es eliminado poco después.',
      },
      {
        title: 'FRANCIA, MÚSICA Y PAYASO',
        text: 'El origen francés de Jade, el violín, el ballet y las pinturas se conectan como una red simbólica.',
      },
    ],
    doubts: [
  ...
  },
  {
    ...
    summary:
      'La entidad podría adoptar formas humanas completas, diferenciadas de las simples visiones que solo percibe un personaje.',
    thesis:
      'La teoría distingue apariciones espectrales —como el Padre Khatri o Tom— de presencias físicas que pueden ser vistas por más de una persona. Abby y Martin aparecen como candidatos principales a formas robadas por la entidad. Más adelante, las transformaciones de Sofía y las promesas hechas a otros personajes amplían esta línea.',
    evidence: [
      {
        title: 'VISIÓN FRENTE A CUERPO',
        text: 'Cuando otros personajes ven a la aparición o interactúan con ella, podría tratarse de una forma física y no de una alucinación privada.',
      },
      {
        title: 'ABBY',
        text: 'Su recuerdo del lugar, su cambio de conducta y ciertas apariciones posteriores permiten sospechar una sustitución o imitación.',
      },
      {
        title: 'MARTIN',
        text: 'Julie también lo ve y su conocimiento sobre Boyd y la caja de música lo sitúa por encima de una visión ordinaria.',
      },
      {
        title: 'SOFÍA Y OTRAS FORMAS',
        text: 'Las transcripciones de T4 desarrollan la idea de que el Hombre de Amarillo elige una apariencia distinta para cada objetivo.',
      },
    ],
    doubts: [
  ...
  },
  {
    ...
    summary:
      'Los elementos que parecen no conectar podrían proceder de miedos y relatos diferentes convertidos en realidad por el lugar.',
    thesis:
      'Las cigarras, gusanos, monstruos y otras amenazas no formarían una mitología uniforme porque serían pesadillas extraídas de distintas personas. Fromville reutilizaría temores, palabras, cuentos y anticipaciones para construir nuevas reglas o criaturas. Esto explica la variedad, pero también plantea si los personajes crean el futuro o si simplemente lo presagian.',
    evidence: [
      {
        title: 'CIGARRAS DE NATHAN',
        text: 'Sara plantea que las cigarras podrían proceder del miedo de su hermano y haber sido reutilizadas después de su muerte.',
      },
      {
        title: 'PALABRAS QUE SE CUMPLEN',
        text: 'Conversaciones sobre gusanos, miedos y relatos parecen anticipar elementos que más tarde aparecen físicamente.',
      },
      {
        title: 'MITOLOGÍAS INCOMPATIBLES',
        text: 'La diversidad de amenazas deja de ser un error de conexión si cada una tiene un origen psicológico diferente.',
      },
      {
        title: 'CREACIÓN O DESTINO',
        text: 'La teoría mantiene abierta la duda de si Fromville copia pensamientos o si los personajes recuerdan sin saberlo algo que ya ocurrirá.',
      },
    ],
    doubts: [
  ...
  },
  {
    ...
    summary:
      'La energía de quienes mueren en Fromville podría transferirse a los monstruos y mantener activo el ciclo.',
    thesis:
      'La resurrección de Roger mediante el sacrificio de un pollito se interpreta como una demostración de intercambio vital: una vida paga otra. A partir de ahí, las personas atrapadas y asesinadas serían la fuente constante que sostiene la inmortalidad de los monstruos, del Hombre de Amarillo o del propio lugar.',
    evidence: [
      {
        title: 'INTERCAMBIO DE VIDAS',
        text: 'El huevo y la resurrección de Roger visualizan que la energía no aparece gratis y que una vida puede transformarse en otra.',
      },
      {
        title: 'MUERTOS ATRAPADOS',
        text: 'Si quienes mueren no abandonan Fromville, su energía podría quedar disponible para el sistema.',
      },
      {
        title: 'CICLOS COMO COMBUSTIBLE',
        text: 'La llegada repetida de habitantes garantiza una entrada continua de vida, sufrimiento y esperanza.',
      },
      {
        title: 'CONSUMO DE CUERPOS',
        text: 'El Hombre de Amarillo consumiendo órganos se relaciona con una absorción directa de energía vital.',
      },
    ],
    doubts: [
  ...
  },
  {
    ...
    summary:
      'Los objetos personales podrían retener una parte de sus dueños, activar recuerdos y permitir que la entidad imite apariencias.',
    thesis:
      'Las pertenencias guardadas por Víctor, las gafas, los anillos, las pulseras repetidas y las máquinas de recuerdos forman una línea común: los objetos mantienen un vínculo con las personas. Esta regla podría explicar tanto la recuperación de memorias como la capacidad del Hombre de Amarillo para adoptar formas ajenas.',
    evidence: [
      {
        title: 'ARCHIVO DE VÍCTOR',
        text: 'El Niño de Blanco le pide conservar objetos de los fallecidos, convirtiéndolos en sustitutos de la memoria del pueblo.',
      },
      {
        title: 'OBJETOS REPETIDOS',
        text: 'Pulseras y anillos similares aparecen ligados a reencarnaciones o vidas que repiten patrones.',
      },
      {
        title: 'RECORDAR PERMITE VOLVER',
        text: 'La aparición física del Hombre de Amarillo se relaciona con el momento en que Jade y Tabitha recuperan recuerdos.',
      },
      {
        title: 'ROBO DE APARIENCIAS',
        text: 'Si un objeto contiene una parte de su dueño, la entidad podría usarlo como acceso a su forma o identidad.',
      },
    ],
    doubts: [
...
export const SOURCES: SourceData[] = [
  {
    ...
    summary:
      'Propone que la variedad de amenazas procede de pesadillas, miedos y relatos diferentes materializados por Fromville.',
  ...
  },
  {
    ...
    summary:
      'Formula el universo de bolsillo y lo conecta con el portal, el bucle espacial, las rocas rojas, el sacrificio y un posible final que encierre a la entidad.',
  ...
  },
  {
    ...
    summary:
      'Diferencia visiones y apariciones físicas para estudiar si Abby y Martin fueron formas adoptadas por el Hombre de Amarillo.',
  ...
  },
  {
    ...
    summary:
      'Construye la identificación entre el Niño de Blanco y el Faraway Tree y conserva una teoría alternativa sobre el niño del opening.',
  ...
  },
  {
    ...
    summary:
      'Plantea que la esperanza escapó al árbol, que el ritual sigue abierto y que algunos habitantes podrían ser los niños reencarnados.',
  ...
  },
  {
    ...
    summary:
      'Reinterpreta a Jade y Christopher mediante Jasper, Toby, Francia y el sacrificio, aunque termina presentándose como un ejercicio poco probable.',
  ...
  },
  {
    ...
    summary:
      'Actualiza el archivo con la muerte de Jim, el simbolismo del colgado, la cronología de Jade, el valor de los objetos y nuevas pistas sobre el Lago de las Lágrimas.',
  ...
  },
  {
    ...
    summary:
      'Profundiza en las formas del Hombre de Amarillo, los recuerdos, las posibles reencarnaciones y la absorción de energía vital.',
  ...
  },
  {
    ...
    order: 9,
    phase: 'TEMPORADA 4',
    code: 'TEORÍA INTERMEDIA',
    kind: 'theory',
    title: '¿El Plan de Jade es la SALIDA? | Teoría FROM Serie Temporada 4',
    summary:
      'Reúne las pistas que apuntan hacia las cuevas y el lago, pero mantiene abierta la posibilidad de que la visión de Jade sea una manipulación.',
  ...
  },
  {
    ...
    summary:
      'Pone a prueba el plan de las cuevas, recupera dibujos del lago y estudia si los tótems pueden convertirse en armas contra los monstruos.',
  ...
  },
  {
    ...
    summary:
      'La revelación pública de las reencarnaciones da paso a la teoría del intercambio de vidas, la energía que sostiene a los monstruos y el fracaso inicial de los tótems.',
  ...
  },
  {
    ...
    summary:
      'Acelera el descenso a las cuevas, el arranque del árbol, la protección de la sala y la idea de que la entidad adopta apariencias diferentes para manipular.',
  ...
  },
  {
    ...
    order: 13,
    phase: 'TEMPORADA 4',
    code: 'TRÁILER EPISODIO 10',
    kind: 'trailer',
    title: '¿El Final del Ciclo? Análisis y teorías del tráiler del Episodio 10 | FROM Serie T4',
    summary:
      'Anticipa el posible fracaso del plan, catástrofes, sacrificios, pérdida de protección y un nuevo reinicio del ciclo.',
